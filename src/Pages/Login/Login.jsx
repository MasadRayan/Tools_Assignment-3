...
const Login = () => {
    const { loginUser, setUser, signImWithGoogle, signInWithGitHub } = useAuth();
            ...
            <div className="w-full lg:w-1/2 flex flex-col">
                ...
                <div className="flex-1 flex items-center justify-center p-6">
                    ...
                    >
                        ...
                        <p className="font-semibold mb-6">Enter your credentials to access your account</p>
                        ...
                        <div className='bg-base-100 card shadow-2xl '>
                            ...
                            <div>
                                <p className="text-center my-2">Don't have an account? <Link to="/register" state={{ from: location.state?.from || { pathname: '/' } }} className="text-[#4A70A9]">Sign up</Link></p>
                            </div>
